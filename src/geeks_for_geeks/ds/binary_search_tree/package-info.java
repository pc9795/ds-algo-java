 ...
 *
 * Finding minimum and maximum can be implemented in O(1) by keeping an extra pointer to minimum
 * or maximum and updating the pointer with insertion and deletion if required. With delete we can
 * update by finding inorder predecessor or successor.
 *
 * Advantages
