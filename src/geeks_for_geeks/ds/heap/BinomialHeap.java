...
//      Combining degrees.
//      We only check for nextNext because their can only be three nodes of same degrees, one of current heap,
//      other for merging heap and one from merger of previous nodes. (Every heap have single tree for some degree)
