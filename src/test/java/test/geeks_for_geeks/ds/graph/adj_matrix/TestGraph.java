package test.geeks_for_geeks.ds.graph.adj_matrix;

import geeks_for_geeks.ds.graph.adj_matrix.Applications;
import geeks_for_geeks.ds.graph.adj_matrix.Graph;
import geeks_for_geeks.ds.graph.adj_matrix.UndirectedGraph;
...
class TestGraph {
    ...
    void testMinimizeCashFlow() {
        ...
        assert Applications.minimizeCashFlow(graph).
                equals(Arrays.asList(new Pair<>(1, new Pair<>(2, 4000)), new Pair<>(0, new Pair<>(2, 3000))));
    }
