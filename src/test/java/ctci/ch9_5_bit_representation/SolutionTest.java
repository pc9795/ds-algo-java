...
class SolutionTest {
  ...
  private static Stream<Arguments> testBinaryToString() {
    return Stream.of(
        Arguments.of(1.2, 32, "ERROR"), Arguments.of(.33, 32, "ERROR"), Arguments.of(.24, 32, ""));
  }
  ...
  private static Stream<Arguments> testFlipBitToWin() {
    return Stream.of(
        Arguments.of(1775, 8), Arguments.of(Integer.parseInt("100", 2), 2), Arguments.of(31, 5));
  }
  ...
  private static Stream<Arguments> testConversion() {
    return Stream.of(Arguments.of(29, 15, 2));
  }
