...
class SolutionTest {
  private static Stream<Arguments> testRemoveDups() {
    return Stream.of(
        ...
        Arguments.of(
            new SinglyLinkedList().append(1).append(2).append(2),
            new SinglyLinkedList().append(1).append(2)),
        Arguments.of(
            new SinglyLinkedList().append(1).append(1).append(1),
  ...
  private static Stream<Arguments> testDeleteMiddleNode() {
    ...
    return Stream.of(
        ...
        Arguments.of(list2, list2.getHead().next, new SinglyLinkedList().append(1).append(3)));
  }

  @ParameterizedTest
  @MethodSource("testDeleteMiddleNode")
  void testDeleteMiddleNode(
      SinglyLinkedList input, SinglyLinkedList.Node ref, SinglyLinkedList expected) {
  ...
  void testSumListsInForwardOrder(
      SinglyLinkedList list1, SinglyLinkedList list2, SinglyLinkedList result) {
  ...
  private static Stream<Arguments> testIsIntersecting() {
    ...
    return Stream.of(Arguments.of(list1, list2, true), Arguments.of(list1, list3, false));
  }
  ...
  void testGetLoopPoint() {
    ...
    SinglyLinkedList.Node i = list.getHead();
    while (i.next != null) {
      i = i.next;
    }
