...
class TestSinglyLinkedList {
  ...
  private static Stream<Arguments> testSwap() {
    return Stream.of(
        Arguments.of(
            new SinglyLinkedList().append(1, 2, 3, 4, 5),
            2,
            4,
            new SinglyLinkedList().append(1, 4, 3, 2, 5)),
        Arguments.of(
            new SinglyLinkedList().append(1, 2, 3, 4, 5),
            2,
            3,
            new SinglyLinkedList().append(1, 3, 2, 4, 5)),
        Arguments.of(
            new SinglyLinkedList().append(1, 2, 3, 4, 5),
            1,
            2,
            new SinglyLinkedList().append(2, 1, 3, 4, 5)),
        Arguments.of(
            new SinglyLinkedList().append(1, 2, 3, 4, 5),
            1,
            3,
            new SinglyLinkedList().append(3, 2, 1, 4, 5)),
        Arguments.of(
            new SinglyLinkedList().append(1, 2, 3, 4, 5),
            2,
            5,
            new SinglyLinkedList().append(1, 5, 3, 4, 2)),
        Arguments.of(
            new SinglyLinkedList().append(1, 2, 3, 4, 5),
            1,
            5,
            new SinglyLinkedList().append(5, 2, 3, 4, 1)));
  }

  @ParameterizedTest
  @MethodSource("testSwap")
  ...
  private static Stream<Arguments> testSortedMerge() {
    return Stream.of(
        Arguments.of(
            new SinglyLinkedList().append(1, 2, 3), null, new SinglyLinkedList().append(1, 2, 3)),
        Arguments.of(
            null, new SinglyLinkedList().append(1, 2, 3), new SinglyLinkedList().append(1, 2, 3)),
        Arguments.of(
            new SinglyLinkedList().append(1, 2, 3),
        ...
        Arguments.of(
            ...
            new SinglyLinkedList().append(1, 2, 3)),
        Arguments.of(
            new SinglyLinkedList().append(1, 3, 5),
            new SinglyLinkedList().append(2, 4),
            new SinglyLinkedList().append(1, 2, 3, 4, 5)),
        Arguments.of(
            new SinglyLinkedList().append(2, 4),
            new SinglyLinkedList().append(1, 3, 5),
