...
class TestGraph {
    ...
    void testAddEdgeToDAG() {
        ...
        assert Applications.addEdgeInDAG(new GraphBase.Edge[]{
                new GraphBase.Edge(3, 0), new GraphBase.Edge(4, 5), new GraphBase.Edge(0, 2)
        }, graph).equals(new HashSet<>(Arrays.asList(new GraphBase.Edge(0, 3), new GraphBase.Edge(5, 4),
                new GraphBase.Edge(0, 2))));
    }
    ...
    void testGetBridges() {
        UndirectedGraph graph = new UndirectedGraph(5);
        graph.addEdge(1, 0).addEdge(0, 3).addEdge(3, 4).addEdge(2, 0).addEdge(1, 2);
        boolean ans = GraphBase.getBridges(graph).equals(Arrays.asList(new GraphBase.Edge(3, 4), new GraphBase.Edge(0, 3)));
        assert ans;
    }
