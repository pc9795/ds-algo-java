...
class TestTrie {
  ...
  // In a unique key no part of key contains another key (prefix), nor the key itself is prefix of
  // another key in trie)
  @Test
  ...
  void testLongestPrefixMatching() {
    Set<String> dict =
        new HashSet<>(Arrays.asList("are", "area", "base", "cat", "cater", "children", "basement"));
