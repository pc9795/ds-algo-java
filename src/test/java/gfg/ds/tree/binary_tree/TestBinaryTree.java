...
class TestBinaryTree {
  ...
  void testPrintAncestors() {
    BinaryTree bt =
        new BinaryTree()
            ...
            .insertAtPos("00", 4)
            .insertAtPos("01", 5);
    List<Integer> ans = Applications.getAncestors(bt, new BinaryTree.BinaryTreeNode(4));
  ...
  void testIsSubTree() {
    ...
    tree.root.right = new BinaryTree.BinaryTreeNode(6);
    tree.root.right.right = new BinaryTree.BinaryTreeNode(7);
