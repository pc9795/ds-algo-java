...
class TestAVLTree {
    ...
    void testRightRotate() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method rightRotateMethod = avlTree.getClass().getDeclaredMethod("rightRotate", BinaryTree.BinaryTreeNode.class);
        rightRotateMethod.setAccessible(true);
        BinaryTree.BinaryTreeNode result = (BinaryTree.BinaryTreeNode) rightRotateMethod.invoke(avlTree, binaryTree.root);
    ...
    void testLeftRotate() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method leftRotateMethod = avlTree.getClass().getDeclaredMethod("leftRotate", BinaryTree.BinaryTreeNode.class);
        leftRotateMethod.setAccessible(true);
        BinaryTree.BinaryTreeNode result = (BinaryTree.BinaryTreeNode) leftRotateMethod.invoke(avlTree, binaryTree.root);
