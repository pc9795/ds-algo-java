...
class TestAVLTree {
  ...
  void testRightRotate()
    ...
    binaryTree.insertAtPos("1", 6).insertAtPos("0", 3).insertAtPos("01", 4).insertAtPos("00", 2);

    Method rightRotateMethod =
        avlTree.getClass().getDeclaredMethod("rightRotate", BinaryTree.BinaryTreeNode.class);
    rightRotateMethod.setAccessible(true);
    BinaryTree.BinaryTreeNode result =
        (BinaryTree.BinaryTreeNode) rightRotateMethod.invoke(avlTree, binaryTree.root);
  ...
  void testLeftRotate()
    ...
    binaryTree.insertAtPos("0", 2).insertAtPos("1", 5).insertAtPos("10", 4).insertAtPos("11", 6);

    Method leftRotateMethod =
        avlTree.getClass().getDeclaredMethod("leftRotate", BinaryTree.BinaryTreeNode.class);
    leftRotateMethod.setAccessible(true);
    BinaryTree.BinaryTreeNode result =
        (BinaryTree.BinaryTreeNode) leftRotateMethod.invoke(avlTree, binaryTree.root);
