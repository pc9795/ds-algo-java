...
class TestRedBlackTree {
    ...
    void testRightRotate() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method rightRotateMethod = rbTree.getClass().getDeclaredMethod("rightRotate", BinaryTree.BinaryTreeNode.class);
    ...
    void testLeftRotate() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method leftRotateMethod = rbTree.getClass().getDeclaredMethod("leftRotate", BinaryTree.BinaryTreeNode.class);
