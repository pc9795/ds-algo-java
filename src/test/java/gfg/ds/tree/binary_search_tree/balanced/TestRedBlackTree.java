...
class TestRedBlackTree {
  ...
  void testRightRotate()
    ...
    Method rightRotateMethod =
        rbTree.getClass().getDeclaredMethod("rightRotate", BinaryTree.BinaryTreeNode.class);
  ...
  void testLeftRotate()
    ...
    Method leftRotateMethod =
        rbTree.getClass().getDeclaredMethod("leftRotate", BinaryTree.BinaryTreeNode.class);
  ...
  void testInsert() {
    ...
    assert BinaryTree.levelOrderTraversal(rbTree).stream()
  ...
  void testDelete() {
     ...
     * Node with parenthesis are black
     */
    assert BinaryTree.inOrderTraversal(rbTree)
        .equals(Arrays.asList(2, 3, 6, 7, 8, 10, 11, 13, 18, 22, 26));
    assert BinaryTree.levelOrderTraversal(rbTree).stream()
        .flatMap(Collection::stream)
        .collect(Collectors.toList())
