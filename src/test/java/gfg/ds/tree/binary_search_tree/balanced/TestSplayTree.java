...
class TestSplayTree {
  ...
  void testZig() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    ...
    Method zigMethod =
        splayTree.getClass().getDeclaredMethod("zig", BinaryTree.BinaryTreeNode.class);
    zigMethod.setAccessible(true);
    BinaryTree.BinaryTreeNode result =
        (BinaryTree.BinaryTreeNode) zigMethod.invoke(splayTree, binaryTree.root);
  ...
  void testZag() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    ...
    Method zagMethod =
        splayTree.getClass().getDeclaredMethod("zag", BinaryTree.BinaryTreeNode.class);
    zagMethod.setAccessible(true);
    BinaryTree.BinaryTreeNode result =
        (BinaryTree.BinaryTreeNode) zagMethod.invoke(splayTree, binaryTree.root);
