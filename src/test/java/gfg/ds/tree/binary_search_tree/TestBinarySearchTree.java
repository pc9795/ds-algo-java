...
class TestBinarySearchTree {
    ...
    void testFindPairWithGivenSum() {
        ...
        Pair<BinaryTree.BinaryTreeNode, BinaryTree.BinaryTreeNode> result = Applications.findPairWithGivenSum(bst, 33);
        assert result.equals(new Pair<>(new BinaryTree.BinaryTreeNode(8), new BinaryTree.BinaryTreeNode(25)));

        result = Applications.findPairWithGivenSum(bst, 24);
        assert result.equals(new Pair<>(new BinaryTree.BinaryTreeNode(8), new BinaryTree.BinaryTreeNode(16)));
    ...
    void testFindPreSuc() {
        ...
        assert ans.equals(new Pair<>(new BinaryTree.BinaryTreeNode(3), new BinaryTree.BinaryTreeNode(5)));
    }
