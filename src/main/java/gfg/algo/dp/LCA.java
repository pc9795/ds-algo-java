...
public class LCA {
     ...
     * t=O(sqrt(n))
     */
    public static NryTree.NryNode lca(NryTree tree, int height, NryTree.NryNode a, NryTree.NryNode b) {
    ...
    private static void traverseUtil(NryTree.NryNode currentNode, Map<NryTree.NryNode, NryTree.NryNode> sectionParent, int sectionWidth) {
    ...
    private static NryTree.NryNode lcaUtil(NryTree.NryNode a, NryTree.NryNode b, Map<NryTree.NryNode, NryTree.NryNode> sectionParent) {
