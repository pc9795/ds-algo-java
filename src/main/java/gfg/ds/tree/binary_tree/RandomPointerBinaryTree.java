...
public class RandomPointerBinaryTree {
  ...
  private void fixRandomLinks(
      RandomPointerBinaryTreeNode originalRoot, RandomPointerBinaryTreeNode cloneRoot) {
  ...
  private static void inOrderTraversalUtil(
      RandomPointerBinaryTreeNode root, List<Integer> traversal) {
    if (root == null) {
      return;
    }
  ...
  public static class RandomPointerBinaryTreeNode {
    ...
    public String toString() {
      return "BTNodeWithRandom{"
          ...
          + data
          + "["
          + (this.random == null ? "Null" : this.random.data)
          + "]"
          + '}';
    }
  }
