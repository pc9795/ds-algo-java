...
public class Applications {
    ...
    private static void correctBSTIfTwoNodesAreSwappedUtil(BinaryTree.BinaryTreeNode root,
    ...
    public static List<Integer> mergedInorder(BinarySearchTree first, BinarySearchTree second) {
        ...
        ArrayDeque<BinaryTree.BinaryTreeNode> leftOver = firstStack.isEmpty() ? secondStack : firstStack;
    ...
    private static void convertBinaryTreeToBSTUtil(BinaryTree.BinaryTreeNode root, List<Integer> inOrder, DoublePointer<Integer> index) {
        if (root == null) {
            return;
        }
