...
public final class Applications {
  ...
  /**
   * t=O(n); If data is partially sorted =O(n*log n); Otherwise s=O(n); Priority queue size is
  ...
  public static List<Integer> cartesianTreeSort(List<Integer> input) {
    ...
    PriorityQueue<CartesianTree.CartesianTreeNode> maxHeap =
        new PriorityQueue<>((o1, o2) -> o2.getData() - o1.getData());
    ...
    // Right now cartesian tree is using max-heap that's why we have to reverse the data. Can use
    // Min-heap based
