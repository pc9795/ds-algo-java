...
public class UndirectedGraph extends GraphBase {
    ...
    public List<Pair<Integer, Integer>> getEulerPath() {
        ...
        //If there are 0 odd vertices then we can start from any where if 2 then we have to start from any of them.
        for (int i = 0; i < vertices; i++) {
    ...
    private void getEulerPathUtil(int source, List<Pair<Integer, Integer>> eulerPath) {
        //Copying to a new list so that doesn't throw ConcurrentModificationException. Can improve this.
