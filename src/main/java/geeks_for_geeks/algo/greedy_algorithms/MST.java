...
public class MST {
     ...
     * we get MST for a connected geeks_for_geeks.graph only, so in a connected geeks_for_geeks.graph V=O(E) therefore O(E+V) -> O(E)
     * In case of densely connected geeks_for_geeks.graph E->V^2.
     *
     * @param graph
     * @return
     */
...
//                        If we implement our own geeks_for_geeks.heap with a map to get the position in O(1) time then it will take
//                        O(log n) time.
