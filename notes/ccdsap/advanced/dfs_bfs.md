...
This new graph is dag. Observe that if c1->c2 in the SCC dag, the max exit number in c1 is bigger than the max exit
number
in c2.
...
Now, we look at unmarked vertex with highest exit number. This is in a different SCC. Once again, if we start a DFS
here,
