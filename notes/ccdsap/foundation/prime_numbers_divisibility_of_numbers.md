...
in the range [sqrt(N),N]. If no prime factors exist in the range [1,sqrt(N)], then N itself is prime and there is no
need to continue searching beyond that range.
