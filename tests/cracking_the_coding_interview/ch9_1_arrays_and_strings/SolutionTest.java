...
class SolutionTest {
    ...
    static Stream<Arguments> testCheckPermutation() {
        return Stream.of(
    ...
    static Stream<Arguments> testUrlify() {
        return Stream.of(
    ...
    static Stream<Arguments> testPalindromePermutation() {
        return Stream.of(
                Arguments.of("", true),
                Arguments.of("a", true),
    ...
    static Stream<Arguments> testOneAway() {
        return Stream.of(
    ...
    static Stream<Arguments> testStringCompression() {
        return Stream.of(
                Arguments.of(null, ""),
                Arguments.of("", ""),
