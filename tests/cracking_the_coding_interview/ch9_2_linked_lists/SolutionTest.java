 ...
 **/
class SolutionTest {
    static Stream<Arguments> testRemoveDups() {
        return Stream.of(
    ...
    static Stream<Arguments> testKthFromLast() {
        return Stream.of(
    ...
    static Stream<Arguments> testDeleteMiddleNode() {
    ...
    static Stream<Arguments> testSumLists() {
        return Stream.of(
                Arguments.of(
    ...
    static Stream<Arguments> testSumListsInForwardOrder() {
        return Stream.of(
                Arguments.of(
    ...
    static Stream<Arguments> testIsIntersecting() {
